...
### Features
- Data Cleaning & Preprocessing: Handle missing values, outliers, and inconsistent data.
- Exploratory Data Analysis (EDA): Visualize trends, patterns, and relationships in data.
- Modeling: Apply statistical and machine learning models for predictions and insights.
- Data Visualization: Create charts and dashboards to communicate findings effectively.
- Business Insights: Generate actionable recommendations based on analytical results.

---

#### Technologies
- Programming: Python, SQL
- Python Libraries: `pandas`, `numpy`, `matplotlib`, `seaborn`, `plotly`, `scikit-learn` , `pytorch`
